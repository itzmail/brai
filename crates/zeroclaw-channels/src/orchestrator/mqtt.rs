...
use brai_config::schema::MqttConfig;
use brai_runtime::sop::audit::SopAuditLogger;
use brai_runtime::sop::dispatch::{dispatch_sop_event, process_headless_results};
use brai_runtime::sop::engine::{SopEngine, now_iso8601};
use brai_runtime::sop::types::{SopEvent, SopTriggerSource};
...
pub async fn run_mqtt_sop_listener(
    ...
    brai_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                brai_runtime::health::mark_component_error("mqtt", e.to_string());
