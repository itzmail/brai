...
mod tests {
    ...
    fn test_mappings() -> Vec<RoleMapping> {
        vec![
            ...
            RoleMapping {
                ...
                brai_permissions: vec!["file_read".into(), "memory_search".into()],
    ...
    fn duplicate_normalized_roles_are_rejected() {
        let mappings = vec![
            ...
            RoleMapping {
                nevis_role: " ADMIN ".into(),
                brai_permissions: vec!["file_read".into()],
