...
//!    `~/.brai/firmware/pico/` if it isn't there yet.
...
/// Ensure `~/.brai/firmware/pico/` exists and contains the bundled assets.
///
...
mod tests {
    ...
    fn ensure_firmware_dir_creates_directory() {
        // This test verifies ensure_firmware_dir creates the ~/.brai/firmware/pico/ path.
