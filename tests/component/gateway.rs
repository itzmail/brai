...
//! verification) in isolation. The gateway module (`brai::gateway`) exposes
...
use brai::gateway::verify_whatsapp_signature;
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        brai::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        brai::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
